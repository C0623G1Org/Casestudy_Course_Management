...
public class Course {
    ...
    public Course(int id, String name, String description, String instructor, double price, int courseLevelId, String knowledge, String requirements, String courseInclusion, String avatar) {
        this.id = id;
        this.name = name;
    ...
    public Course(String name, String description, String instructor, double price, int courseLevelId, String knowledge, String requirements, String courseInclusion, String avatar) {
        this.name = name;
        this.description = description;
        this.instructor = instructor;
        this.price = price;
