...
public class Course {
    ...
    public Course(int id, String courseName, String descriptionCourse, double priceCourse, String knowledge, String requirements, String name, String description, double price) {
        this.id = id;
        this.name = name;
        this.description = description;
        this.price = price;
