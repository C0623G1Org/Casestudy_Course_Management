            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group my-3">
                        ...
                        <input type="text" class="form-control" id="nameBC" placeholder="Vui lòng nhập tên" value="${user.getFullName()}">
                    </div>
                    <div class="form-group my-3">
                        <label for="numberphoneBC"><i class="fa-solid fa-phone"></i> Số điện thoại của bạn*</label>
                        <input type="text" class="form-control" id="numberphoneBC" placeholder="Vui lòng nhập số điện thoại" value="${user.getPhone()}">
                    </div>
                    <div class="form-group my-3">
                        <label for="EmailBC"><i class="fa-solid fa-envelope"></i> Email của bạn*</label>
                        <input type="text" class="form-control" id="EmailBC" placeholder="Vui lòng nhập email" value="${user.getEmail()}">
                    </div>
